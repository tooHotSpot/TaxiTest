...
CREATE TABLE IF NOT EXISTS `TaxiTest`.`Taxi` (
  ...
  INDEX `fk_Car_has_Driver_Driver1_idx` (`Driver_idDriver` ASC) VISIBLE,
  INDEX `fk_Car_has_Driver_Car1_idx` (`Car_idCar` ASC) VISIBLE,
  PRIMARY KEY (`Car_idCar`, `Driver_idDriver`),
  INDEX `fk_Taxi_Address1_idx` (`Current_idAddress` ASC) VISIBLE,
  CONSTRAINT `fk_Car_has_Driver_Car1`
...
CREATE TABLE IF NOT EXISTS `TaxiTest`.`Order` (
  ...
  `Rate` INT NULL,
  PRIMARY KEY (`idOrder`),
  INDEX `fk_Order_Car_has_Driver1_idx` (`Taxi_idTaxi` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Order_Car_has_Driver`
